...
function Hero() {
    const images = [
        'images/happy-asian-young-family-homeowners-bought-new-house-japanese-mom-dad-daughter-embracing-looking-forward-future-new-home-after-moving-relocation-sitting-sofa-with-boxes-together-min.jpg',
        'images/happy-young-couple-sitting-sofa-living-room-home-use-tablet-with-happiness-together-happy-family-concept.jpg',
        'images/happy-asian-family-using-tablet-video-call-virtual-meeting-together-sofa-home-living-room.jpg', // Add the second image path here
    ];
