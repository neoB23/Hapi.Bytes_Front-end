...
<div className="flex flex-wrap md:flex-nowrap items-center h-screen">
    ...
    <div className="bg-white w-full md:w-1/2 h-auto md:h-screen flex items-center justify-center p-6 md:p-0">
        <div className="mx-4 md:mx-20 space-y-6 md:space-y-10">
            ...
            <section className="text-gray-600 body-font j p-24">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-20">
                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Discover Our Services</h1>
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Lorem Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum</p>
                    </div>
                    <div className="flex flex-wrap -m-4 text-center">
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                        <svg fill="none" stroke="currentColor" strokeLinecap="round" stroke-linejoin="round" stroke-width="2" className="text-indigo-500 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
