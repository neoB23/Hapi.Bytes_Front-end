                            ...
                            <div className="p-8 mt-6 lg:mt-0 leading-normal rounded shadow bg-white">
                                {section === 'section1' && (
                                    ...
                                    <div class="md:col-span-5">
                                      ...
                                      <input type="text" name="email" id="email" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="dummy@gmail.com" />
                                    </div>
                      
                                    <div class="md:col-span-2">
                                      <label for="city">City</label>
                                      <div class="h-10 bg-gray-50 flex border border-gray-200 rounded items-center mt-1">
                                        <select name="city" id="city" class="px-4 appearance-none outline-none text-gray-800 w-full bg-transparent">
                                ...
                                {section === 'section2' && (
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                      <div class="md:col-span-5">
                                        ...
                                        <input type="text" name="full_name" id="full_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="not required" />
                                      </div>
                                      ...
                                      <div class="md:col-span-1">
                                        ...
                                        <input type="text" name="address" id="address" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="Not Requried" />
                                      </div>
                                      ...
                                      <div class="md:col-span-2">
                                        ...
                                        <input type="text" name="city" id="city" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="House number / Block and lot / Street / Subdivision" />
                                      </div>
                                  </div>
                                    
                                )}
                                {section === 'section3' && (
                                        <form class="grid grid-cols-3 gap-2 w-full  flex items-center">
                                          <div >
                                            ...
                                            <label class="flex flex-col p-4 border-2 border-gray-400 cursor-pointer" for="radio_1">
                                              <span class="text-xs font-semibold uppercase">HB EXTRA</span>
                                              <span class="text-xl font-bold mt-2">₱699/month</span>
                                          ...
                                          <div>
                                            ...
                                            <label class="flex flex-col p-4 border-2 border-gray-400 cursor-pointer" for="radio_2">
                                              <span class="text-xs font-semibold uppercase">HB LITE</span>
                                              <span class="text-xl font-bold mt-2">₱999/month</span>
                                              <ul class="text-sm mt-2">
                                              <li>Speed: 45 Mbps</li>
                                              <li>Fiber Fast Unli Data</li>
                                              </ul>
                                          ...
                                          <div>
                                            ...
                                            <label class="flex flex-col p-4 border-2 border-gray-400 cursor-pointer" for="radio_3">
                                              <span class="text-xs font-semibold uppercase">HB PLUS</span>
                                              <span class="text-xl font-bold mt-2">₱1299/month</span>
                                              <ul class="text-sm mt-2">
                                              <li>Speed: 70 Mbps</li>
                                              <li>Fiber Fast Unli Data</li>
                                              </ul>
                                          ...
                                          <div >
                                            ...
                                            <label class="flex flex-col p-4 border-2 border-gray-400 cursor-pointer" for="radio_4">
                                              <span class="text-xs font-semibold uppercase">HB MEGA</span>
                                              <span class="text-xl font-bold mt-2">₱1499/month</span>
                                              <ul class="text-sm mt-2">
                                          ...
                                          <div >
                                            ...
                                            <label class="flex flex-col p-4 border-2 border-gray-400 cursor-pointer" for="radio_5">
                                              <span class="text-xs font-semibold uppercase">HB GIGA</span>
                                              <span class="text-xl font-bold mt-2">₱1699/month</span>
                                              <ul class="text-sm mt-2">
                                          ...
                                          <div >
                                            ...
                                            <label class="flex flex-col p-4 border-2 border-gray-400 cursor-pointer" for="radio_6">
                                              <span class="text-xs font-semibold uppercase">HB TERA</span>
                                              <span class="text-xl font-bold mt-2">₱2499/month</span>
                                              <ul class="text-sm mt-2">
                                    ...
                                    <div id='section3' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                                        <div>
                                              ...
                                              <div class="space-y-1 text-center">
                                                  <svg class="mx-auto h-12 w-12 text-white" stroke="black" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                                                ...
                                                <div className="bg-white p-6 rounded shadow-lg w-1/3">
                                                  ...
                                                  By clicking "Agree" or continuing to interact with the service, you confirm that you have read, understood, and agreed to these Terms of Service.
                                                    <div class="flex space-x-2 items-center p-6 ">
                                                      <button onClick={closeModal}  data-modal-toggle="default-modal" type="button" class="text-white bg-blue hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">I accept</button>
